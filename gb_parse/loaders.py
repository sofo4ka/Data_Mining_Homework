...
from .items import InstagramTagItem
...
class InstagramTagLoader(ItemLoader):
    ...
    id_out = TakeFirst()
    name_out = TakeFirst()
    allow_following_out = TakeFirst()
    is_following_out = TakeFirst()
    is_top_media_only_out = TakeFirst()
    profile_pic_url_out = TakeFirst()
    edge_hashtag_to_top_posts_out = TakeFirst()
